...
import revenueRoutes from '@/routes/transactions/revenue';
...
export default function RevenueIndex({ transactions, summary }: Props) {
            ...
            <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl p-4">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        <a href={revenueRoutes.export().url}>
                ...
                <div className="grid gap-4 md:grid-cols-3">
                    ...
                    <Card>
                        <CardContent className="p-6">
                            ...
                            <div className="mt-2 text-2xl font-bold text-green-600 dark:text-green-400">
                                {formatCurrency(summary.revenue_last_30_days)}
                            </div>
                        </CardContent>
                    </Card>
                    <Card>
                            ...
                            <tbody>
                                {transactions.data.length === 0 ? (
                                    <tr>
                                        ...
                                        >
                                            No revenue transactions yet. Create your first
                                            revenue transaction to get started.
                                        </td>
                                    </tr>
                                ) : (
