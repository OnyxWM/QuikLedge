...
import { BookOpen, Folder, LayoutGrid, Menu, Receipt, Search, TrendingDown, TrendingUp } from 'lucide-react';
...
function isNavItemActive(item: NavItem, currentUrl: string): boolean {
    const resolvedHref = resolveUrl(item.href);
    
    // For Transactions, only match exact /transactions
    ...
    return isSameUrl(currentUrl, item.href);
}
                                ...
                                {mainNavItems.map((item, index) => (
                                    ...
                                    >
                                        <Link
                                            ...
                                            className={cn(
                                                navigationMenuTriggerStyle(),
                                                isNavItemActive(item, page.url) && activeItemStyles,
